...
xi.magic.spell =
{
    ...
    REFRESH_III           =  894,
    TEMPER_II             =  895,
    SHANTOTTO             =  896, -- Quest: Curses_Foiled_A_Golem
    NAJI                  =  897, -- Bastok Mission 1_1
    KUPIPI                =  898, -- Nation Mission 2_x_x
    EXCENMILLE            =  899,
    AYAME                 =  900, -- Bastok Mission 2_1
    NANAA_MIHGO           =  901, -- Quest: "Mihgo's Amigo"
    CURILLA               =  902, -- Quest: The_Generals_Secret
    VOLKER                =  903,
    AJIDO_MARUJIDO        =  904, -- Windurst Mission 9_2
    TRION                 =  905, -- ToAU Mission 4
    ZEID                  =  906, -- BCNM Clear: The Shadowlord Battle
    LION                  =  907, -- Nation Mission 2_3_1
    TENZEN                =  908,
    MIHLI_ALIAPOH         =  909,
    VALAINERAL            =  910,
    JOACHIM               =  911,
    ...
    STAR_SIBYL            =  935,
    KARAHA_BARUHA         =  936,
    CID                   =  937, -- Quest: Cids_Secrect
    GILGAMESH             =  938,
    AREUHAT               =  939,
    SEMIH_LAFIHNA         =  940, -- Rank 3
    ELIVIRA               =  941,
    NOILLURIE             =  942,
    LHU_MHAKARACCA        =  943,
    FERREOUS_COFFIN       =  944,
    ...
    ROMAA_MIHGO           =  949,
    KUYIN_HATHDENNA       =  950,
    RAHAL                 =  951, -- Quest: The_Holy_Crest
    KORU_MORU             =  952, -- Quest: Blast_from_the_Past
    PIEUJE_UC             =  953,
