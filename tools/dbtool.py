...
def configure_multi_process_by_modulus_100():
    configure_multi_process_by_modulus(100)
...
def tasks_menu():
    present_menu(
        "Maintenance Tasks",
        {
            ...
            "h": [
                "Configure multi-process server (100 processes)",
                configure_multi_process_by_modulus_100,
            ],
            "u": [
